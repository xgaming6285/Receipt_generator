document.addEventListener("alpine:init", () => {
  Alpine.data("billGenerator", () => ({
    ...
    items: [
      { sno: 1, name: "", description: "", quantity: 0, amount: 0, total: 0 },
    ],
    tax: 0,
    notes: "",
    templates: [
      {
        name: "Template 1",
        imageUrl: "https://via.placeholder.com/200x300?text=Template+1",
      },
      {
        name: "Template 2",
        imageUrl: "https://via.placeholder.com/200x300?text=Template+2",
      },
      {
        name: "Template 3",
        imageUrl: "https://via.placeholder.com/200x300?text=Template+3",
      },
      {
        name: "Template 4",
        imageUrl: "https://via.placeholder.com/200x300?text=Template+4",
      },
      {
        name: "Template 5",
        imageUrl: "https://via.placeholder.com/200x300?text=Template+5",
      },
      {
        name: "Template 6",
        imageUrl: "https://via.placeholder.com/200x300?text=Template+6",
      },
      {
        name: "Template 10",
        imageUrl: "https://via.placeholder.com/57x38?text=Template+10",
      },
    ],
